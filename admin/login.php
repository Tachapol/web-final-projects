<?php 
  ...
  require_once('../php/connect.php');
    if (isset($_POST['submit'])) {
      ...
      $post_id = (isset($_POST['username'])) ? $_GET['username'] : '';
...
<div class="login-box">
  <!-- /.login-logo -->
  <section >
      <div class="card card-login shadow p-3 p-md-4">
        <div class="card-body login-card-body">
          <p class="login-box-msg">
            <h1 class="text-primary text-center font-weight-bold">DBCondo Login</h1>
            <h3 class="text-center">เข้าสู่ระบบหลังบ้าน</h3>
          </p>

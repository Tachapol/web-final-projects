...
<!-- Section Page-Title -->
    <header class="page-title jarallax" data-jarallax='{"speed": 0.4 }' style="background-image: url(../../../assets/images/condo/plumfresh.jpg);">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="../php/contact.php">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="phone">Line/Facebook</label>

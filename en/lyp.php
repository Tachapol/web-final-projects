...
<!-- Section Page-Title -->
    <header class="page-title jarallax" data-jarallax='{ "speed": 0.4 }' style="background-image: url('https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80');">
        <div class="page-image text-center">
            <h1 class="display-4 font-weight-bold">LIST YOUR PROPERTY</h1>
            <p class="lead"></p>
        </div>
    </header>

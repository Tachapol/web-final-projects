...
<head>
    ...
    <title>คอนโดให้เช่า ใกล้ม.กรุงเทพ</title>
     ...
     <!-- Section Meta Tag -->
        <!-- Search Engine -->
        <meta name="description" content="<?php echo $row['details_en']?>">
        ...
        <meta itemprop="description" content="<?php echo $row['details_en']?>">
        <meta itemprop="image" content="<?php echo $base_path_blog.$row['image']?>">
        <!-- Twitter -->
        <meta name="twitter:card" content="summary">
        <meta name="twitter:title" content="DB Condo">
        <meta name="twitter:description" content="<?php echo $row['details_en']?>">
        <!-- Open Graph general (Facebook, Pinterest & Google+) -->
        <meta name="fb:app_id" content="">
        <meta name="og:title" content="DB Condo">
        <meta name="og:description" content="<?php echo $row['details_en']?>">
...
<!-- Section Page-Title -->
    <header class="jarallax" data-jarallax='{ "speed":0.4 }' style="background-image: url('<?php echo $base_path_blog.$row['image']?>');">
        <div class="page-image text-center">
            <h4 class="display-4 font-weight-bold"> <?php echo $row['name_en']?></h4>
            <p class="lead"> <?php echo $row['details_en']?> </p>
        </div>
    </header>
...
<!-- Section Blog -->
    ...
    <!-- facebook comments -->
            <!-- <div class="col-12">
                ...
                data-href="plum/en/rent_detail.php?id=<?php $row['id'];?>" 
                data-width="100%" 
                data-numposts="5"></div>
            <div id="fb-root"></div>
            ...
            <!-- <div class="owl-carousel owl-theme">
                <?php while($row_RAND = $result_RAND->fetch_assoc()){ ?>
                    <section class="col-12 p-2">
                        <div class="card">
                            <a href="rent_detail.php?id=<?php echo $row_RAND['id']?>" class="warpper-card-img">
                                <img class="card-img-top" src="<?php echo $base_path_blog.$row_RAND['image'] ?>">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $row_RAND['name_en']; ?></h5>
                                <p class="card-text"><?php echo $row_RAND['details_en']; ?></p>
                            </div>
                            <div class="p-3">
                                <a href="rent_detail.php?id=<?php echo $row_RAND['id']?>" class="btn btn-viewmore">อ่านเพิ่มเติม</a>
                            </div>
                        </div>
                    </section>
                <?php } ?>
